export default {
    ...
    wake_up: 'Weckzeit',
    current_time: 'Momentane Zeit',
    time_to_fall_asleep: 'Zeit bis zum Einschlafen',
    sleep_cycle_table: 'Schlafzyklus-Tabelle',
    go_to_bed: 'Zu Bett gehen',
    sleep_cycles: 'Schlafzyklen',
    sleep_cycle_text: 'Sie müssen um {time} Uhr ins Bett gehen, um {amount} Schlafzyklen zu haben.',
    sun_data: 'Sonnendaten',
